...
/* =========================================================
   HEADER PREMIUM — BÚSQUEDA Y MENÚ MÓVIL ABELISSE.COM
========================================================= */
...
if (searchBtn) searchBtn.onclick = buscarProducto;
if (searchInput) searchInput.onkeydown = (e) => e.key === "Enter" && buscarProducto();
            ...
            <a href="producto.html?id=${product.id}" class="product-link">
              ...
              <div class="product-body">
                ...
                <div class="product-prices">
                  <p class="price-main">S/ ${Number(product.precio_venta_soles).toFixed(2)}</p>
                </div>
